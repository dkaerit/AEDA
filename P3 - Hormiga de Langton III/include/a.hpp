...
namespace AED
{
    ...
    public:
        Old_McDonals_farm_habitant_t(const char *name): name_()
        {
            strcpy(name_, name);
        }
    ...
    public:
        water_animal_t(const char *name): Old_McDonals_farm_habitant_t(name)
        {}
    ...
    public:
        cow_t(const char *name): ground_animal_t(name, 4)
        {}
    ...
    {
    public:
        chicken_t(const char *name): ground_animal_t(name, 2)
        {}
    ...
    public:
        whale_t(const char *name): water_animal_t(name)
        {}
    ...
    {
    public:
        shark_t(const char *name) :  water_animal_t(name)
        {}
