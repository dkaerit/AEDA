...
int protectedMain(int argc, char* argv[]) {
    ...
    for(int i = 0; i < 20; i++) {
        ...
        Dummy::cont = 0;
        cout << "ABE(" << setw(3) << k << "): " << abe.buscar(k) << ", contador: " << setw(3) << Dummy::cont << "  //  ";

        Dummy::cont = 0;
        cout << "ABB(" << setw(3) << k << "): " << abb.buscar(k) << ", contador: " << setw(3) << Dummy::cont << "  //  ";

        Dummy::cont = 0;
        cout << "AVL(" << setw(3) << k << "): " << avl.buscar(k) << ", contador: " << setw(3) << Dummy::cont << endl;
    }
