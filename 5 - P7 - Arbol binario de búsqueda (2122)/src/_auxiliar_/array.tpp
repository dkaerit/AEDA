...
class Array {
    ...
    public:
        ...
        // funciones cola
        void insertar(int i, type t) { base.push_back(keyval<type>(i,t)); } // inserta en la posición i
        void extraer(int& i, type& t) { t = base[0].second; i = base[0].first; base.pop_front(); } // elimina de la posición i
        bool empty() const { return base.empty(); } // devuelve true si está vacío
