...
class Array {
    ...
    public:
        ...
        void insertar(type t, int i) { base.push_back(keyval<type>(i,t)); } // inserta en la posición i
        void extraer(type& t, int& i) { t = base[0].second; i = base[0].first; base.pop_front(); } // elimina de la posición i
